                    ...
                    <div class="register-form">
                        <form method="POST" action="{{ route('register') }}" name="register-form" class="needs-validation"
                            ...
                            <div class="d-flex align-items-center mb-3 pb-2">
                                <p class="m-0">Dữ liệu cá nhân của bạn sẽ được sử dụng để hỗ trợ trải nghiệm trên toàn bộ trang web này, quản lý quyền truy cập vào tài khoản của bạn và các mục đích khác được mô tả trong chính sách bảo mật của chúng tôi.
                                </p>
                            </div>
                            ...
                            <div class="customer-option mt-4 text-center">
                                ...
                                <a href="{{ route('login') }}" class="btn-text js-show-register">Đăng nhập ngay</a>
                            </div>
                        </form>
                    </div>
                </div>
