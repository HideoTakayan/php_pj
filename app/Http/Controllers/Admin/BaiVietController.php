 ...
 * CRUD bài viết, upload ảnh bìa
 */
class BaiVietController extends Controller
{
    // Danh sách bài viết (có tìm kiếm, eager loading user)
    ...
    // Lưu bài viết mới (upload ảnh bìa)
    ...
    // Cập nhật bài viết (xóa ảnh cũ, upload ảnh mới)
    ...
    // Xóa bài viết (xóa cả ảnh trong storage)
